debug(){
    python train_model.py --dataset mnist --clf cnn --paradigm hl --num-workers 125 --batch-size 16 --num-clusters 25 1 --epochs 21 --lr 0.01 --non-iid 10 --repeat 1 --eut-range 10 --lut-intv 2 --rounds 50 --eut-seed 0 --accuracy 0.8 --patience 0 --channel 2 --dry-run 0
}
